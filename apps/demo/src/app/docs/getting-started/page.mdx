...
The library is built with minimal default styling,
giving you full control over its appearance.
It provides a set of semantic CSS classes that you can target,
as well as props to pass your own class names.
